...
class BenthosCarryingCap(Importer):
    def __init__(self):
        super(BenthosCarryingCap, self).__init__(
            "benthosspe_{name}/benthos_biomass_carrying_capacity_K_per_landscape_per_funcgr.dat"
        )
    ...
    def import_file(self, db):
        ...
        for landscape_id, value in rows[1:]:
                if (oldlandscape_id != landscape_id):
                    funcgrp_id = 0
                db.insert_benthos_parameter_with_funcgrp(landscape_id, "carryingCap", value,
